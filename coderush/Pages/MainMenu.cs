...
namespace coderush.Pages
{
    public static class MainMenu
    {
        ...
        {
            public const string PageName = "Hàng hóa";
        ...
        {
            public const string PageName = "Phiếu đặt hàng";
        ...
        {
            public const string PageName = "Hóa đơn đặt hàng";
        ...
        {
            public const string PageName = "Phiếu mua hàng";
        ...
        {
            public const string PageName = "Giao hàng";
        ...
        {
            public const string PageName = "Hóa đơn bán hàng";
        ...
        {
            public const string PageName = "Phiếu thanh toán";
        ...
        {
            public const string PageName = "Loại hóa đơn đặt hàng";
        ...
        {
            public const string PageName = "Tiền mặc";
        ...
        {
            public const string PageName = "Loại hóa đơn bán hàng";
        ...
        {
            public const string PageName = "Loại thanh toán";
        ...
        {
            public const string PageName = "Loại hàng hóa";
        ...
        {
            public const string PageName = "Loại bán hàng";
        ...
        {
            public const string PageName = "Loại vận chuyển";
        ...
        {
            public const string PageName = "Kho";
        ...
        {
            public const string PageName = "Loại đặt hàng";
        ...
        {
            public const string PageName = "Vai trò";
        ...
        {
            public const string PageName = "Thay đổi vai trò";
        ...
        {
            public const string PageName = "Trang điều khiển";
