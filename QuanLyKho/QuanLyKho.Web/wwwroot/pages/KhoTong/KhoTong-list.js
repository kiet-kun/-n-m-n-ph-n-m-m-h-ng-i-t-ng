...
$(document).ready(function () {
    var datatable = $('#datatable').dataTable({
        ...
        "processing": true,
        "paging": true,
        "sAjaxSource": "/KhoTong/List",
        "info": true,
        "fnServerData": function (sSource, aoData, fnCallback, oSettings) {
            aoData.push(
                { "name": "returnformat", "value": "plain" },
                { "name": "ten", "value": $('input[name="ten"]').val() },
                { "name": "khotongcode", "value": $('input[name="khotongcode"]').val() },
            ...
            [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        var buttons = "";
                        buttons += '<a href="/KhoTong/Edit/' + row.Id + '" class="btn btn-xs btn-warning"><i class="fas fa-pen"></i> Cập nhật</a>&nbsp;'
